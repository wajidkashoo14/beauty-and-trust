...
export default function TransportCard({ image, title, description, numberOfPassengers }) {
  ...
  return (
    <div class="w-80 text-left border-solid border-2 border-[#F4F4F4] cursor-pointer shadow-xl transition-all ease-linear duration-200 hover:-translate-y-3 max-[600px]:w-full max-[600px]:mb-5">
      <Image
        src={image}
        sizes="100vw"
        width={320}
